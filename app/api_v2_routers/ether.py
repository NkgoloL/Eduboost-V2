...
from app.services.archetype_service_service import ArchetypeService, OnboardingResponse
...
async def get_questions():
    ...
    return await ArchetypeService().get_onboarding_questions()
...
async def submit_onboarding(
    ...
    return await ArchetypeService().determine_archetype(response)
