...
async def run_deep_readiness_runtime_checks(
    *,
    db_session: Any | None = None,
    cache_client: Any | None = None,
    required_tables: tuple[str, ...] = ("users", "learners"),
) -> DeepReadinessRuntimeResult:
    checks: list[DeepReadinessCheckResult] = []
    try:
    ...
    return DeepReadinessRuntimeResult(overall, tuple(checks))
