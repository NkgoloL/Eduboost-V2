...
code_anchors: ["app/domain/knowledge_graph_learner_shadow.py", "app/domain/knowledge_graph_runtime_activation.py", "app/domain/knowledge_graph_authority_switch.py"]
---
