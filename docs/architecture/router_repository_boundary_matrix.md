...
Generated at: `2026-08-29T09:32:55Z`
...
| `app/api_v2_routers/consent.py` | False | - | - | - |
| `app/api_v2_routers/consent_renewal.py` | False | - | - | - |
| `app/api_v2_routers/content_factory.py` | False | - | - | - |
...
| `app/api_v2_routers/gamification.py` | False | - | - | - |
...
| `app/api_v2_routers/learners.py` | False | - | - | - |
| `app/api_v2_routers/lessons.py` | True | - | - | - |
| `app/api_v2_routers/observability_sre.py` | False | - | - | - |
| `app/api_v2_routers/onboarding.py` | False | - | - | - |
| `app/api_v2_routers/parents.py` | False | - | - | - |
