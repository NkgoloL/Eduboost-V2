...
| `app/api_v2_routers/gamification.py` | `app.api_v2_deps.auth` | `app.services.fourth_estate`, `app.services.gamification_service_v2`, `app.services.learner_service` | - | `app.core.database`, `sqlalchemy.ext.asyncio` |
...
| `app/api_v2_routers/learners.py` | `app.api_v2_deps.auth` | `app.services.learner_service`, `app.services.popia_service` | - | `app.core.database`, `sqlalchemy.ext.asyncio` |
...
| `app/api_v2_routers/onboarding.py` | `app.api_v2_deps.auth` | `app.services.ether`, `app.services.learner_service` | - | `app.core.database`, `sqlalchemy.ext.asyncio` |
| `app/api_v2_routers/parents.py` | `app.api_v2_deps.auth` | `app.services.executive`, `app.services.learner_service`, `app.services.popia_service` | - | `app.core.database`, `sqlalchemy.ext.asyncio` |
