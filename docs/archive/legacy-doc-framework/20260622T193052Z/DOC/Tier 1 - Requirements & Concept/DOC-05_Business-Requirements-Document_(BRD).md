...
EduBoost addresses foundational learning gaps by offering affordable, adaptive, CAPS-aligned learning support for South African primary learners. The business value is not policy-advisory automation; it is improved learner mastery, guardian visibility and controlled content expansion.

## Business objectives

| ID | Objective | Metric | Current/target interpretation |
|---|---|---|---|
| BO-01 | Launch a credible scoped learning product. | Grade 4 Mathematics launch slice is covered and verified. | Scope refs 4.M.1.1, 4.M.1.2, 4.M.1.3. |
| BO-02 | Improve learning personalisation. | Diagnostic mastery gaps drive lessons and study plans. | Diagnostics, IRT and study-plan services. |
| BO-03 | Build trust with parents. | Parent dashboard, reports and POPIA workflows are present. | Parent portal and data-rights APIs. |
| BO-04 | Control AI/content risk. | Human review, provenance and answer-key checks before promotion. | Content Factory gates. |
| BO-05 | Support operational readiness. | Green CI/staging/security/release evidence before launch claims. | Roadmap and release gates. |

## Business capabilities

- Learner onboarding and profile creation.
- Diagnostic assessment and adaptive ability calibration.
- Lesson generation and learner tutor support.
- Study plans based on curriculum coverage and mastery gaps.
- Gamification to reinforce engagement.
- Parent/guardian progress and privacy portal.
- Content Factory governance for scalable CAPS expansion.

## Success criteria

| Criterion | Evidence required |
|---|---|
| Launch-slice curriculum readiness | Coverage matrix, seed evidence, content registry and runtime smoke proof. |
| Learning-path usability | Browser E2E journey for learner onboarding, diagnostic, lesson and study plan. |
| Privacy readiness | POPIA data-rights tests and legal evidence package. |
| Operational readiness | Migrations, runtime import, OpenAPI drift, route inventory, backend and frontend tests. |
| Release governance | ATO decision, risk register review and stakeholder sign-off. |
