...
- Database/repository evidence is indexed by
  `docs/database/db_repository_evidence.md` and checked by
  `make db-repository-check`; live migration smoke evidence remains open.
