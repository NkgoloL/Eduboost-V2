...
- Observability/ops evidence is indexed by
  `docs/operations/observability_ops_evidence.md` and checked by
  `make observability-ops-check`; live alert/dashboard evidence remains open.
