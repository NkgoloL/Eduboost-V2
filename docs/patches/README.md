---
title: "Documentation Patches Directory Overview"
status: archived
...
supersedes: []
superseded_by: docs/archive/patches/20260622T193052Z/patches
...
- Original path: `docs/patches`
- New path: `docs/archive/patches/20260622T193052Z/patches`
- Reason: Patch notes archived after application.
