...
Generated at: `2026-05-17T14:32:38Z`

| Check | Return code | Command |
|---|---:|---|
| consent runtime compatibility | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_consent_runtime_compatibility_slice.py` |
| audit registry | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_audit_canonicalization_registry.py` |
| implementation foundation | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_backend_consolidation_implementation_foundation.py` |
| schema/deep/audit slice | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_audit_canonicalization_slice.py` |
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_consent_runtime_compatibility_slice.py`
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_audit_canonicalization_registry.py`
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_backend_consolidation_implementation_foundation.py`
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python3 scripts/check_audit_canonicalization_slice.py`
