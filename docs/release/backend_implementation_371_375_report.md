---
title: "Release — Backend Implementation 371-375 Report"
status: "active"
owner: "release"
...
Generated at: `2026-09-02T21:25:51Z`

| Check | Return code | Command |
|---|---:|---|
| backend implementation 371-375 | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_implementation_371_375.py` |
...
| consent runtime | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py` |
| deep readiness | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_deep_readiness_readonly_guard.py` |
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_deep_readiness_readonly_guard.py`
