---
title: "Release — Backend Runtime Integration Readiness Report"
status: "active"
owner: "release"
...
Generated at: `2026-08-29T09:32:27Z`

| Check | Return code | Command |
|---|---:|---|
| runtime integration readiness | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_runtime_integration_readiness.py` |
| runtime integration blocklists | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_runtime_integration_blocklists.py` |
| 431-450 wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_first_consent_and_deep_readiness_runtime_wiring.py` |
| 421-430 wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_first_audit_runtime_wiring.py` |
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_runtime_integration_readiness.py`
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_runtime_integration_blocklists.py`
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_first_consent_and_deep_readiness_runtime_wiring.py`
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_first_audit_runtime_wiring.py`
