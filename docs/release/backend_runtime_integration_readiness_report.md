---
title: Backend Runtime Integration Readiness Report
...
Generated at: `2026-06-27T02:22:23Z`

| Check | Return code | Command |
|---|---:|---|
| runtime integration readiness | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python scripts/check_backend_runtime_integration_readiness.py` |
| runtime integration blocklists | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python scripts/check_backend_runtime_integration_blocklists.py` |
| 431-450 wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python scripts/check_first_consent_and_deep_readiness_runtime_wiring.py` |
| 421-430 wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python scripts/check_first_audit_runtime_wiring.py` |
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python scripts/check_backend_runtime_integration_readiness.py`
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python scripts/check_backend_runtime_integration_blocklists.py`
