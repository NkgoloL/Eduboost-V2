---
title: Consent Call-Site Inventory
...
| `tests/integration/test_parent_progress_authorization.py` | 78 | require_active_consent | `async def require_active_consent(self, learner_id: str, actor_id: str \| None = None) -> None:` |
