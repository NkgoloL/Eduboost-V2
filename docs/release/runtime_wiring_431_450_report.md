...
Generated at: `2026-08-19T19:16:02Z`

| Check | Return code | Command |
|---|---:|---|
| consent/deep readiness wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python3 scripts/check_first_consent_and_deep_readiness_runtime_wiring.py` |
| destructive-action scan | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python3 scripts/check_runtime_wiring_no_destructive_actions.py` |
| first audit runtime wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python3 scripts/check_first_audit_runtime_wiring.py` |
| runtime enablement | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python3 scripts/check_backend_runtime_enablement_guard.py` |
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python3 scripts/check_runtime_wiring_no_destructive_actions.py`
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-phase02r-gate2r1/.venv/bin/python3 scripts/check_backend_runtime_enablement_guard.py`
