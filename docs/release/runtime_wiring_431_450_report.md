---
title: "Release — Runtime Wiring 431-450 Report"
status: "active"
owner: "release"
...
Generated at: `2026-09-02T21:28:21Z`

| Check | Return code | Command |
|---|---:|---|
| consent/deep readiness wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_first_consent_and_deep_readiness_runtime_wiring.py` |
| destructive-action scan | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_runtime_wiring_no_destructive_actions.py` |
| first audit runtime wiring | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_first_audit_runtime_wiring.py` |
| runtime enablement | 0 | `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py` |
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_runtime_wiring_no_destructive_actions.py`
...
Command: `/home/nkgolol/Dev/SandBox/Eduboost-V2-coverage-clean-20260817/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py`
