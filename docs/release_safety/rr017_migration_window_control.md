---
title: "RR-017 Migration Window Control"
status: active
...
# RR-017 Migration Window Control
...
Production database mutation is recorded as requiring an approved migration window, rollback path, and release-owner control before execution.
