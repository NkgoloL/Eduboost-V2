---
title: "Atlas — Phase 2 Execution Plan — Semantic Retrieval and Grounding"
status: "active"
owner: "engineering"
...
SEMANTIC_EMBEDDING_PROVIDER=deterministic \
  ...
  --output docs/release-evidence/atlas/phase-02/retrieval_metrics.json
```
...
| Artifact | Path |
|---|---|
| Execution plan | `docs/roadmap/execution/atlas/phase_02_execution_plan.md` |
| Implementation report | `docs/roadmap/execution/atlas/phase_02_implementation_report.md` |
| Evidence pack/index | `docs/release-evidence/atlas/phase-02/phase_02_evidence_index.md` |
| Independent audit | `docs/release-evidence/atlas/phase-02/phase_02_audit_report.md` |
