...
**Status:** Gate 2R.2 verified complete; Gate 2R.3 authorised
**Execution authorisation:** Gate 2R.3 only
**Phase:** 02R
...
**Current decision:** Gate 2R.2 is Verified Complete. Gate 2R.3 is Authorised. `PHASE_02R_START_APPROVED` remains `true` because Phase 2R execution has started, while `phase_02r_start_gate_control.json` authorises only Gate 2R.2.
