# LEV-01.01 — Implementation Task Card
...
Create a mastery-construct working group with psychometric, mathematics-education, teacher, product, data-science, privacy and runtime-KG representation.
...
- `docs/research/longitudinal_validation/evidence/01.01_approved_charter_named_decision_rights_and_meeting_cadence.md`

## Implementation procedure

1. Read the LEV-WS01 workstream specification and confirm prerequisites for task 01.01.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create a mastery-construct working group with psychometric, mathematics-education, teacher, product, data-science, privacy and runtime-KG representation.
...
6. Attach or link the required evidence: Approved charter, named decision rights and meeting cadence.
...
- [ ] Approved charter, named decision rights and meeting cadence.
