# LEV-01.02 — Implementation Task Card
...
Inventory every current mastery-related field, API response, dashboard label, recommendation rule, report statement and production-readiness claim.
...
- `docs/research/longitudinal_validation/evidence/01.02_complete_mastery_usage_inventory_with_source_locations_and_owners.md`

## Implementation procedure

1. Read the LEV-WS01 workstream specification and confirm prerequisites for task 01.02.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Inventory every current mastery-related field, API response, dashboard label, recommendation rule, report statement and production-readiness claim.
...
6. Attach or link the required evidence: Complete mastery-usage inventory with source locations and owners.
...
- [ ] Complete mastery-usage inventory with source locations and owners.
