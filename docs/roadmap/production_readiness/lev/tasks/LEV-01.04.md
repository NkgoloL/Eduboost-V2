# LEV-01.04 — Implementation Task Card
...
Define the unit of inference for each construct: item, skill, CAPS topic, KG concept, prerequisite cluster, strand and grade-level outcome.
...
- `docs/research/longitudinal_validation/evidence/01.04_inference_unit_matrix_with_no_ambiguous_aggregation_paths.md`

## Implementation procedure

1. Read the LEV-WS01 workstream specification and confirm prerequisites for task 01.04.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define the unit of inference for each construct: item, skill, CAPS topic, KG concept, prerequisite cluster, strand and grade-level outcome.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Inference-unit matrix with no ambiguous aggregation paths.
...
- [ ] Inference-unit matrix with no ambiguous aggregation paths.
