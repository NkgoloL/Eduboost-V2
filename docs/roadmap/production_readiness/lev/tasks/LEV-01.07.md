# LEV-01.07 — Implementation Task Card
...
Define permitted instructional uses, teacher-facing uses, learner-facing wording, parent-facing wording and research-only uses.
...
- `docs/research/longitudinal_validation/evidence/01.07_authorised_use_register_completed.md`

## Implementation procedure

1. Read the LEV-WS01 workstream specification and confirm prerequisites for task 01.07.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define permitted instructional uses, teacher-facing uses, learner-facing wording, parent-facing wording and research-only uses.
...
6. Attach or link the required evidence: Authorised-use register completed.
...
- [ ] Authorised-use register completed.
