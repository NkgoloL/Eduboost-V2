# LEV-01.12 — Implementation Task Card
...
Create a claims-change-control process requiring impact assessment whenever definitions, thresholds, graph structure or decision authority change.
...
- `docs/research/longitudinal_validation/evidence/01.12_change_control_workflow_and_approver_matrix_operational.md`

## Implementation procedure

1. Read the LEV-WS01 workstream specification and confirm prerequisites for task 01.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create a claims-change-control process requiring impact assessment whenever definitions, thresholds, graph structure or decision authority change.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Change-control workflow and approver matrix operational.
...
- [ ] Change-control workflow and approver matrix operational.
