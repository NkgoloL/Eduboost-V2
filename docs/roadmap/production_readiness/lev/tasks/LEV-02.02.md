# LEV-02.02 — Implementation Task Card
...
Create a CAPS coverage blueprint by strand, topic, subtopic, concept, cognitive demand, representation and expected instructional period.
...
- `docs/research/longitudinal_validation/evidence/02.02_approved_curriculum_blueprint_with_explicit_coverage_targets.md`

## Implementation procedure

1. Read the LEV-WS02 workstream specification and confirm prerequisites for task 02.02.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create a CAPS coverage blueprint by strand, topic, subtopic, concept, cognitive demand, representation and expected instructional period.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Approved curriculum blueprint with explicit coverage targets.
...
- [ ] Approved curriculum blueprint with explicit coverage targets.
