# LEV-02.05 — Implementation Task Card
...
Conduct independent concept-level review for correctness, granularity, prerequisite logic, terminology and grade appropriateness.
...
- `docs/research/longitudinal_validation/evidence/02.05_reviewer_ratings_comments_and_adjudication_record.md`

## Implementation procedure

1. Read the LEV-WS02 workstream specification and confirm prerequisites for task 02.05.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Conduct independent concept-level review for correctness, granularity, prerequisite logic, terminology and grade appropriateness.
...
6. Attach or link the required evidence: Reviewer ratings, comments and adjudication record.
...
- [ ] Reviewer ratings, comments and adjudication record.
