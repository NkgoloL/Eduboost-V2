# LEV-02.06 — Implementation Task Card
...
Conduct graph-level review for missing concepts, duplicated concepts, circular prerequisites, overly broad nodes and invalid dependency paths.
...
- `docs/research/longitudinal_validation/evidence/02.06_graph_quality_report_and_resolved_issue_register.md`

## Implementation procedure

1. Read the LEV-WS02 workstream specification and confirm prerequisites for task 02.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Conduct graph-level review for missing concepts, duplicated concepts, circular prerequisites, overly broad nodes and invalid dependency paths.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Graph quality report and resolved issue register.
...
- [ ] Graph quality report and resolved issue register.
