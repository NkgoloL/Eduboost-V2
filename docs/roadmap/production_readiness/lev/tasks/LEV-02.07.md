# LEV-02.07 — Implementation Task Card
...
Create an operational learning-item bank and a separately protected validation-item bank.
...
- `docs/research/longitudinal_validation/evidence/02.07_physical_logical_separation_and_exposure_control_evidence.md`

## Implementation procedure

1. Read the LEV-WS02 workstream specification and confirm prerequisites for task 02.07.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create an operational learning-item bank and a separately protected validation-item bank.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Physical/logical separation and exposure-control evidence.
...
- [ ] Physical/logical separation and exposure-control evidence.
