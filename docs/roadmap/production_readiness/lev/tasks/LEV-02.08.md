# LEV-02.08 — Implementation Task Card
...
Tag every validation item with concept IDs, CAPS provenance, cognitive process, difficulty hypothesis, language load, representation, scoring rubric and misconception tags.
...
- `docs/research/longitudinal_validation/evidence/02.08_item_metadata_completeness_at_the_approved_threshold.md`

## Implementation procedure

1. Read the LEV-WS02 workstream specification and confirm prerequisites for task 02.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Tag every validation item with concept IDs, CAPS provenance, cognitive process, difficulty hypothesis, language load, representation, scoring rubric and misconception tags.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Item metadata completeness at the approved threshold.
...
- [ ] Item metadata completeness at the approved threshold.
