# LEV-03.02 — Implementation Task Card
...
Specify the canonical mastery-state-transition event with pre-state, post-state, uncertainty, evidence references, model version, graph version and update rationale.
...
- `docs/research/longitudinal_validation/evidence/03.02_versioned_transition_schema.md`

## Implementation procedure

1. Read the LEV-WS03 workstream specification and confirm prerequisites for task 03.02.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Specify the canonical mastery-state-transition event with pre-state, post-state, uncertainty, evidence references, model version, graph version and update rationale.
...
6. Attach or link the required evidence: Versioned transition schema.
