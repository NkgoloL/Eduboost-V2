# LEV-03.05 — Implementation Task Card
...
Create a knowledge-graph snapshot registry and compatibility links between graph, item-bank and model versions.
...
- `docs/research/longitudinal_validation/evidence/03.05_every_projection_resolves_to_a_valid_graph_snapshot.md`

## Implementation procedure

1. Read the LEV-WS03 workstream specification and confirm prerequisites for task 03.05.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create a knowledge-graph snapshot registry and compatibility links between graph, item-bank and model versions.
...
6. Attach or link the required evidence: Every projection resolves to a valid graph snapshot.
...
- [ ] Every projection resolves to a valid graph snapshot.
