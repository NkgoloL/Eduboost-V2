# LEV-03.08 — Implementation Task Card
...
Implement idempotency, duplicate detection, late-event handling, clock-skew handling and correction-event semantics.
...
- `docs/research/longitudinal_validation/evidence/03.08_resilience_and_replay_tests_pass.md`

## Implementation procedure

1. Read the LEV-WS03 workstream specification and confirm prerequisites for task 03.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Implement idempotency, duplicate detection, late-event handling, clock-skew handling and correction-event semantics.
...
6. Attach or link the required evidence: Resilience and replay tests pass.
...
- [ ] Resilience and replay tests pass.
