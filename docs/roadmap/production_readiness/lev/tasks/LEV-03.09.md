# LEV-03.09 — Implementation Task Card
...
Add event completeness, sequencing, orphan-reference and schema-version monitoring.
...
- `docs/research/longitudinal_validation/evidence/03.09_data_quality_dashboards_and_alerts_operational.md`

## Implementation procedure

1. Read the LEV-WS03 workstream specification and confirm prerequisites for task 03.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Add event completeness, sequencing, orphan-reference and schema-version monitoring.
...
6. Attach or link the required evidence: Data-quality dashboards and alerts operational.
