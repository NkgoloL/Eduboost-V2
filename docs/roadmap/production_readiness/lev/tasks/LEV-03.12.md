# LEV-03.12 — Implementation Task Card
...
Run replay validation comparing reconstructed states with production states across a representative sample.
...
- `docs/research/longitudinal_validation/evidence/03.12_no_unexplained_divergence_above_the_approved_tolerance.md`

## Implementation procedure

1. Read the LEV-WS03 workstream specification and confirm prerequisites for task 03.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Run replay validation comparing reconstructed states with production states across a representative sample.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: No unexplained divergence above the approved tolerance.
...
- [ ] No unexplained divergence above the approved tolerance.
