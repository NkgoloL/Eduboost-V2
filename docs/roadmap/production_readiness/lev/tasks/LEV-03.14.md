# LEV-03.14 — Implementation Task Card
...
Create a traceability evidence report and operating procedure for research, incidents and model challenges.
...
- `docs/research/longitudinal_validation/evidence/03.14_operational_runbook_and_approved_evidence_report.md`

## Implementation procedure

1. Read the LEV-WS03 workstream specification and confirm prerequisites for task 03.14.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create a traceability evidence report and operating procedure for research, incidents and model challenges.
...
6. Attach or link the required evidence: Operational runbook and approved evidence report.
...
- [ ] Operational runbook and approved evidence report.
