# LEV-04.03 — Implementation Task Card
...
Build baseline, term and concept-level independent assessment administrations with standardised conditions.
...
- `docs/research/longitudinal_validation/evidence/04.03_administration_manuals_and_secure_form_schedule.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.03.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Build baseline, term and concept-level independent assessment administrations with standardised conditions.
...
6. Attach or link the required evidence: Administration manuals and secure form schedule.
...
- [ ] Administration manuals and secure form schedule.
