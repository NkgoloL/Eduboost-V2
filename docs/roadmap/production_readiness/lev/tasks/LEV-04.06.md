# LEV-04.06 — Implementation Task Card
...
Compare the production model with simple baselines such as last response, rolling accuracy, IRT-only and non-temporal models.
...
- `docs/research/longitudinal_validation/evidence/04.06_benchmark_report.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Compare the production model with simple baselines such as last response, rolling accuracy, IRT-only and non-temporal models.
...
6. Attach or link the required evidence: Benchmark report.
