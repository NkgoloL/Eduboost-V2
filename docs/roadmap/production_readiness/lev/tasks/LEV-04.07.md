# LEV-04.07 — Implementation Task Card
...
Estimate calibration intercept, calibration slope, reliability curves, Brier score, log loss and uncertainty by concept.
...
- `docs/research/longitudinal_validation/evidence/04.07_calibration_report_with_confidence_intervals.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.07.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Estimate calibration intercept, calibration slope, reliability curves, Brier score, log loss and uncertainty by concept.
...
6. Attach or link the required evidence: Calibration report with confidence intervals.
