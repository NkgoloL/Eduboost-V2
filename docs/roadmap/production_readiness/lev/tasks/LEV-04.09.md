# LEV-04.09 — Implementation Task Card
...
Evaluate calibration by evidence count, item exposure, time since evidence, assistance level and concept difficulty.
...
- `docs/research/longitudinal_validation/evidence/04.09_conditional_calibration_analysis.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Evaluate calibration by evidence count, item exposure, time since evidence, assistance level and concept difficulty.
...
6. Attach or link the required evidence: Conditional calibration analysis.
