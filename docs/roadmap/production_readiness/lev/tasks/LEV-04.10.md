# LEV-04.10 — Implementation Task Card
...
Evaluate calibration on unseen learners, unseen items and later time windows.
...
- `docs/research/longitudinal_validation/evidence/04.10_out_of_sample_report.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.10.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Evaluate calibration on unseen learners, unseen items and later time windows.
...
6. Attach or link the required evidence: Out-of-sample report.
