# LEV-04.11 — Implementation Task Card
...
Evaluate subgroup calibration and differential prediction for approved contexts.
...
- `docs/research/longitudinal_validation/evidence/04.11_fairness_calibration_report.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.11.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Evaluate subgroup calibration and differential prediction for approved contexts.
...
6. Attach or link the required evidence: Fairness-calibration report.
