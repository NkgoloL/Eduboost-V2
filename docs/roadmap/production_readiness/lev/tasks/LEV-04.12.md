# LEV-04.12 — Implementation Task Card
...
Develop and test recalibration methods without altering the underlying construct definition.
...
- `docs/research/longitudinal_validation/evidence/04.12_recalibration_protocol_and_holdout_results.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Develop and test recalibration methods without altering the underlying construct definition.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Recalibration protocol and holdout results.
...
- [ ] Recalibration protocol and holdout results.
