# LEV-04.13 — Implementation Task Card
...
Set model release thresholds, uncertainty displays and fallback behaviour when calibration fails.
...
- `docs/research/longitudinal_validation/evidence/04.13_operational_gate_configuration.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.13.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Set model release thresholds, uncertainty displays and fallback behaviour when calibration fails.
...
6. Attach or link the required evidence: Operational gate configuration.
...
- [ ] Operational gate configuration.
