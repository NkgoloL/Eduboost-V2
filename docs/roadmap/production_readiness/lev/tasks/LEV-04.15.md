# LEV-04.15 — Implementation Task Card
...
Automate recurring calibration monitoring against later independent outcomes.
...
- `docs/research/longitudinal_validation/evidence/04.15_production_calibration_dashboard_and_alerting.md`

## Implementation procedure

1. Read the LEV-WS04 workstream specification and confirm prerequisites for task 04.15.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Automate recurring calibration monitoring against later independent outcomes.
...
6. Attach or link the required evidence: Production calibration dashboard and alerting.
...
- [ ] Production calibration dashboard and alerting.
