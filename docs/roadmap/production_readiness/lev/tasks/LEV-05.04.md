# LEV-05.04 — Implementation Task Card
...
Construct confusion matrices for each candidate mastery threshold and outcome horizon.
...
- `docs/research/longitudinal_validation/evidence/05.04_threshold_performance_tables.md`

## Implementation procedure

1. Read the LEV-WS05 workstream specification and confirm prerequisites for task 05.04.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Construct confusion matrices for each candidate mastery threshold and outcome horizon.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Threshold-performance tables.
