# LEV-05.07 — Implementation Task Card
...
Investigate repeated-item exposure, guessing, copying, disengagement and assistance as causes of false mastery.
...
- `docs/research/longitudinal_validation/evidence/05.07_behavioural_confound_report.md`

## Implementation procedure

1. Read the LEV-WS05 workstream specification and confirm prerequisites for task 05.07.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Investigate repeated-item exposure, guessing, copying, disengagement and assistance as causes of false mastery.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Behavioural confound report.
