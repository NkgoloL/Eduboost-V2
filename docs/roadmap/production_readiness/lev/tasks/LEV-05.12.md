# LEV-05.12 — Implementation Task Card
...
Run teacher adjudication studies on sampled disagreements between the model and independent outcomes.
...
- `docs/research/longitudinal_validation/evidence/05.12_disagreement_taxonomy_and_adjudication_evidence.md`

## Implementation procedure

1. Read the LEV-WS05 workstream specification and confirm prerequisites for task 05.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Run teacher adjudication studies on sampled disagreements between the model and independent outcomes.
...
6. Attach or link the required evidence: Disagreement taxonomy and adjudication evidence.
...
- [ ] Disagreement taxonomy and adjudication evidence.
