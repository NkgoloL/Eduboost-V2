# LEV-06.01 — Implementation Task Card
...
Define retention horizons relevant to Grade 4 instruction, provisionally including 2-4 weeks, 8-12 weeks, end of term and cross-year follow-up.
...
- `docs/research/longitudinal_validation/evidence/06.01_approved_retention_framework.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.01.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define retention horizons relevant to Grade 4 instruction, provisionally including 2-4 weeks, 8-12 weeks, end of term and cross-year follow-up.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Approved retention framework.
