# LEV-06.02 — Implementation Task Card
...
Create independent retention probes with parallel items and controlled overlap with instruction.
...
- `docs/research/longitudinal_validation/evidence/06.02_retention_form_manifests.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.02.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create independent retention probes with parallel items and controlled overlap with instruction.
...
6. Attach or link the required evidence: Retention-form manifests.
