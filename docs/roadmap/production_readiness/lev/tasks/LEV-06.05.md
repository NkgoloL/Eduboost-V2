# LEV-06.05 — Implementation Task Card
...
Schedule and administer short-, medium- and long-delay assessments using standardised procedures.
...
- `docs/research/longitudinal_validation/evidence/06.05_administration_completion_report.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.05.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Schedule and administer short-, medium- and long-delay assessments using standardised procedures.
...
6. Attach or link the required evidence: Administration completion report.
...
- [ ] Administration completion report.
