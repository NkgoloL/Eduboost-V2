# LEV-06.07 — Implementation Task Card
...
Compare predictive value of mastery estimates with immediate correctness alone and other baselines.
...
- `docs/research/longitudinal_validation/evidence/06.07_incremental_validity_evidence.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.07.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Compare predictive value of mastery estimates with immediate correctness alone and other baselines.
...
6. Attach or link the required evidence: Incremental-validity evidence.
