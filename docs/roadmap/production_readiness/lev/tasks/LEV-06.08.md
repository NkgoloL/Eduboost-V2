# LEV-06.08 — Implementation Task Card
...
Estimate forgetting curves by concept and learner context, with appropriate multilevel uncertainty.
...
- `docs/research/longitudinal_validation/evidence/06.08_forgetting_curve_report.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Estimate forgetting curves by concept and learner context, with appropriate multilevel uncertainty.
...
6. Attach or link the required evidence: Forgetting-curve report.
