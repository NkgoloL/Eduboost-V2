# LEV-06.10 — Implementation Task Card
...
Evaluate whether uncertainty and staleness indicators correctly identify retention risk.
...
- `docs/research/longitudinal_validation/evidence/06.10_staleness_validation_report.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.10.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Evaluate whether uncertainty and staleness indicators correctly identify retention risk.
...
6. Attach or link the required evidence: Staleness-validation report.
