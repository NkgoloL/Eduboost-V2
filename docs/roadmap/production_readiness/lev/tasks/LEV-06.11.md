# LEV-06.11 — Implementation Task Card
...
Identify concept-specific retention thresholds and review schedules where justified.
...
- `docs/research/longitudinal_validation/evidence/06.11_retention_aware_policy_proposal.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.11.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Identify concept-specific retention thresholds and review schedules where justified.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Retention-aware policy proposal.
...
- [ ] Retention-aware policy proposal.
