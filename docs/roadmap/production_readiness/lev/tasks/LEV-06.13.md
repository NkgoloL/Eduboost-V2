# LEV-06.13 — Implementation Task Card
...
Test whether retention-aware review scheduling improves later independent outcomes.
...
- `docs/research/longitudinal_validation/evidence/06.13_controlled_policy_evaluation.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.13.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Test whether retention-aware review scheduling improves later independent outcomes.
...
6. Attach or link the required evidence: Controlled policy evaluation.
