# LEV-06.15 — Implementation Task Card
...
Monitor retention failure and recalibrate forgetting assumptions over time.
...
- `docs/research/longitudinal_validation/evidence/06.15_operational_retention_dashboard.md`

## Implementation procedure

1. Read the LEV-WS06 workstream specification and confirm prerequisites for task 06.15.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Monitor retention failure and recalibrate forgetting assumptions over time.
...
6. Attach or link the required evidence: Operational retention dashboard.
...
- [ ] Operational retention dashboard.
