# LEV-07.08 — Implementation Task Card
...
Estimate far-transfer performance where curriculum and sample size support the claim.
...
- `docs/research/longitudinal_validation/evidence/07.08_far_transfer_report_with_cautious_scope.md`

## Implementation procedure

1. Read the LEV-WS07 workstream specification and confirm prerequisites for task 07.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Estimate far-transfer performance where curriculum and sample size support the claim.
...
6. Attach or link the required evidence: Far-transfer report with cautious scope.
...
- [ ] Far-transfer report with cautious scope.
