# LEV-07.12 — Implementation Task Card
...
Identify concepts for which the system must not infer transfer without direct evidence.
...
- `docs/research/longitudinal_validation/evidence/07.12_restricted_inference_register.md`

## Implementation procedure

1. Read the LEV-WS07 workstream specification and confirm prerequisites for task 07.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Identify concepts for which the system must not infer transfer without direct evidence.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Restricted-inference register.
