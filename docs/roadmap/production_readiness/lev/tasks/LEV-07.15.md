# LEV-07.15 — Implementation Task Card
...
Maintain item-exposure controls and periodically refresh transfer instruments.
...
- `docs/research/longitudinal_validation/evidence/07.15_operational_exposure_and_renewal_controls.md`

## Implementation procedure

1. Read the LEV-WS07 workstream specification and confirm prerequisites for task 07.15.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Maintain item-exposure controls and periodically refresh transfer instruments.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Operational exposure and renewal controls.
...
- [ ] Operational exposure and renewal controls.
