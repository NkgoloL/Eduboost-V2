# LEV-08.01 — Implementation Task Card
...
Define invariants and reasonableness rules for mastery increases, decreases, uncertainty and prerequisite propagation.
...
- `docs/research/longitudinal_validation/evidence/08.01_state_transition_rule_catalogue.md`

## Implementation procedure

1. Read the LEV-WS08 workstream specification and confirm prerequisites for task 08.01.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define invariants and reasonableness rules for mastery increases, decreases, uncertainty and prerequisite propagation.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: State-transition rule catalogue.
...
- [ ] State-transition rule catalogue.
