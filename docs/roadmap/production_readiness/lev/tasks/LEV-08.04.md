# LEV-08.04 — Implementation Task Card
...
Implement tests ensuring assisted and repeated responses do not automatically equal independent mastery.
...
- `docs/research/longitudinal_validation/evidence/08.04_assistance_aware_test_evidence.md`

## Implementation procedure

1. Read the LEV-WS08 workstream specification and confirm prerequisites for task 08.04.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Implement tests ensuring assisted and repeated responses do not automatically equal independent mastery.
...
6. Attach or link the required evidence: Assistance-aware test evidence.
...
- [ ] Assistance-aware test evidence.
