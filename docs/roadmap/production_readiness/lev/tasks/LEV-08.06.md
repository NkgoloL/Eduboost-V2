# LEV-08.06 — Implementation Task Card
...
Sample real transitions and have teachers and curriculum experts rate their plausibility using a standard rubric.
...
- `docs/research/longitudinal_validation/evidence/08.06_expert_rating_dataset.md`

## Implementation procedure

1. Read the LEV-WS08 workstream specification and confirm prerequisites for task 08.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Sample real transitions and have teachers and curriculum experts rate their plausibility using a standard rubric.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Expert-rating dataset.
