# LEV-08.08 — Implementation Task Card
...
Identify model features or graph relationships causing implausible transitions.
...
- `docs/research/longitudinal_validation/evidence/08.08_root_cause_analysis.md`

## Implementation procedure

1. Read the LEV-WS08 workstream specification and confirm prerequisites for task 08.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Identify model features or graph relationships causing implausible transitions.
...
6. Attach or link the required evidence: Root-cause analysis.
