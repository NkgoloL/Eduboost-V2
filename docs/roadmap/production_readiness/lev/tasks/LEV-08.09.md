# LEV-08.09 — Implementation Task Card
...
Compare state trajectories with alternative models and simple baselines.
...
- `docs/research/longitudinal_validation/evidence/08.09_trajectory_comparison_report.md`

## Implementation procedure

1. Read the LEV-WS08 workstream specification and confirm prerequisites for task 08.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Compare state trajectories with alternative models and simple baselines.
...
6. Attach or link the required evidence: Trajectory comparison report.
