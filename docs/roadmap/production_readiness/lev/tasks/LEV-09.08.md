# LEV-09.08 — Implementation Task Card
...
Test subgroup calibration, discrimination, false mastery, false non-mastery, retention and transfer.
...
- `docs/research/longitudinal_validation/evidence/09.08_context_validity_report.md`

## Implementation procedure

1. Read the LEV-WS09 workstream specification and confirm prerequisites for task 09.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Test subgroup calibration, discrimination, false mastery, false non-mastery, retention and transfer.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Context validity report.
