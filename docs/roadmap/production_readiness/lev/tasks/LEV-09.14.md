# LEV-09.14 — Implementation Task Card
...
Confirm generalisability in an additional school, region, language or delivery context where feasible.
...
- `docs/research/longitudinal_validation/evidence/09.14_external_context_replication_evidence.md`

## Implementation procedure

1. Read the LEV-WS09 workstream specification and confirm prerequisites for task 09.14.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Confirm generalisability in an additional school, region, language or delivery context where feasible.
...
6. Attach or link the required evidence: External-context replication evidence.
...
- [ ] External-context replication evidence.
