# LEV-10.01 — Implementation Task Card
...
Define the intervention precisely: which recommendations use the KG, when, for whom and with what teacher authority.
...
- `docs/research/longitudinal_validation/evidence/10.01_intervention_specification.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.01.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define the intervention precisely: which recommendations use the KG, when, for whom and with what teacher authority.
...
6. Attach or link the required evidence: Intervention specification.
