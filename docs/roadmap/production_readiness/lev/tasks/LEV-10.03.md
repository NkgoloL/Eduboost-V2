# LEV-10.03 — Implementation Task Card
...
Choose the experimental design, preferably cluster randomisation where feasible, and pre-specify the estimand.
...
- `docs/research/longitudinal_validation/evidence/10.03_approved_trial_protocol.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.03.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Choose the experimental design, preferably cluster randomisation where feasible, and pre-specify the estimand.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Approved trial protocol.
