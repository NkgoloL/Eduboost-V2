# LEV-10.04 — Implementation Task Card
...
Perform statistical power and precision calculations accounting for clustering, expected attrition and multiple outcomes.
...
- `docs/research/longitudinal_validation/evidence/10.04_power_analysis.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.04.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Perform statistical power and precision calculations accounting for clustering, expected attrition and multiple outcomes.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Power analysis.
