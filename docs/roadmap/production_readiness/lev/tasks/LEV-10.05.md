# LEV-10.05 — Implementation Task Card
...
Pre-register primary and secondary outcomes, subgroup analyses, mediation analyses and harm boundaries.
...
- `docs/research/longitudinal_validation/evidence/10.05_public_or_controlled_pre_registration_record.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.05.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Pre-register primary and secondary outcomes, subgroup analyses, mediation analyses and harm boundaries.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Public or controlled pre-registration record.
...
- [ ] Public or controlled pre-registration record.
