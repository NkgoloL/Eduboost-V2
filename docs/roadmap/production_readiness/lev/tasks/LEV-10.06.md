# LEV-10.06 — Implementation Task Card
...
Obtain ethics, privacy, school, guardian and learner approvals and establish complaint and withdrawal procedures.
...
- `docs/research/longitudinal_validation/evidence/10.06_complete_governance_approvals.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Obtain ethics, privacy, school, guardian and learner approvals and establish complaint and withdrawal procedures.
...
6. Attach or link the required evidence: Complete governance approvals.
