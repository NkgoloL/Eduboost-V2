# LEV-10.09 — Implementation Task Card
...
Recruit schools/classes, establish baseline equivalence and document the participant flow.
...
- `docs/research/longitudinal_validation/evidence/10.09_recruitment_and_baseline_report.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Recruit schools/classes, establish baseline equivalence and document the participant flow.
...
6. Attach or link the required evidence: Recruitment and baseline report.
...
- [ ] Recruitment and baseline report.
