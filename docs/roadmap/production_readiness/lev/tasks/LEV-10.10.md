# LEV-10.10 — Implementation Task Card
...
Deliver the intervention while measuring fidelity, actual exposure, teacher use and cross-condition contamination.
...
- `docs/research/longitudinal_validation/evidence/10.10_implementation_fidelity_dashboard.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.10.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Deliver the intervention while measuring fidelity, actual exposure, teacher use and cross-condition contamination.
...
6. Attach or link the required evidence: Implementation-fidelity dashboard.
...
- [ ] Implementation-fidelity dashboard.
