# LEV-10.11 — Implementation Task Card
...
Measure independent achievement, retention, transfer, time to durable mastery and opportunity to learn.
...
- `docs/research/longitudinal_validation/evidence/10.11_complete_outcome_dataset.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.11.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Measure independent achievement, retention, transfer, time to durable mastery and opportunity to learn.
...
6. Attach or link the required evidence: Complete outcome dataset.
