# LEV-10.16 — Implementation Task Card
...
Repeat or extend the impact test before broad educational-effectiveness claims.
...
- `docs/research/longitudinal_validation/evidence/10.16_replication_or_confirmatory_study_evidence.md`

## Implementation procedure

1. Read the LEV-WS10 workstream specification and confirm prerequisites for task 10.16.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Repeat or extend the impact test before broad educational-effectiveness claims.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Replication or confirmatory study evidence.
...
- [ ] Replication or confirmatory study evidence.
