# LEV-11.03 — Implementation Task Card
...
Define leading and lagging indicators for each major harm.
...
- `docs/research/longitudinal_validation/evidence/11.03_harm_indicator_catalogue.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.03.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define leading and lagging indicators for each major harm.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Harm indicator catalogue.
