# LEV-11.05 — Implementation Task Card
...
Implement learner-, guardian- and teacher-facing feedback and complaint channels.
...
- `docs/research/longitudinal_validation/evidence/11.05_accessible_feedback_channels_and_response_sla.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.05.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Implement learner-, guardian- and teacher-facing feedback and complaint channels.
...
6. Attach or link the required evidence: Accessible feedback channels and response SLA.
...
- [ ] Accessible feedback channels and response SLA.
