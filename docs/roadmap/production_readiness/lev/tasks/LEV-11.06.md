# LEV-11.06 — Implementation Task Card
...
Establish baseline rates before high-impact adaptation is enabled.
...
- `docs/research/longitudinal_validation/evidence/11.06_baseline_consequence_report.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Establish baseline rates before high-impact adaptation is enabled.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Baseline consequence report.
