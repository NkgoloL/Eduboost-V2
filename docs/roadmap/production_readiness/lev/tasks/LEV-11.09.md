# LEV-11.09 — Implementation Task Card
...
Run qualitative interviews or focus groups on frustration, trust, understanding and teacher workload.
...
- `docs/research/longitudinal_validation/evidence/11.09_qualitative_safety_report.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Run qualitative interviews or focus groups on frustration, trust, understanding and teacher workload.
...
6. Attach or link the required evidence: Qualitative safety report.
