# LEV-11.10 — Implementation Task Card
...
Define and implement mitigations such as content floors, maximum remediation windows, teacher override and mandatory grade-level exposure.
...
- `docs/research/longitudinal_validation/evidence/11.10_mitigation_controls_and_tests.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.10.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define and implement mitigations such as content floors, maximum remediation windows, teacher override and mandatory grade-level exposure.
...
6. Attach or link the required evidence: Mitigation controls and tests.
