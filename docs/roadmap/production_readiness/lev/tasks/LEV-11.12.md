# LEV-11.12 — Implementation Task Card
...
Include adverse outcomes and curriculum-breadth measures in the controlled impact study.
...
- `docs/research/longitudinal_validation/evidence/11.12_trial_consequence_results.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Include adverse outcomes and curriculum-breadth measures in the controlled impact study.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Trial consequence results.
