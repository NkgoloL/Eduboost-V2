# LEV-11.13 — Implementation Task Card
...
Convene an independent safety review before expanding model authority.
...
- `docs/research/longitudinal_validation/evidence/11.13_safety_approval_decision.md`

## Implementation procedure

1. Read the LEV-WS11 workstream specification and confirm prerequisites for task 11.13.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Convene an independent safety review before expanding model authority.
...
6. Attach or link the required evidence: Safety approval decision.
