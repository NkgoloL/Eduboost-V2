# LEV-12.02 — Implementation Task Card
...
Freeze the original protocol, analysis code, model, graph, item and outcome definitions.
...
- `docs/research/longitudinal_validation/evidence/12.02_primary_study_reproducibility_package.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.02.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Freeze the original protocol, analysis code, model, graph, item and outcome definitions.
...
6. Attach or link the required evidence: Primary-study reproducibility package.
...
- [ ] Primary-study reproducibility package.
