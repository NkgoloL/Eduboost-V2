# LEV-12.04 — Implementation Task Card
...
Select a later cohort or academic year and, where possible, additional schools or contexts.
...
- `docs/research/longitudinal_validation/evidence/12.04_replication_sampling_plan.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.04.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Select a later cohort or academic year and, where possible, additional schools or contexts.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Replication sampling plan.
