# LEV-12.06 — Implementation Task Card
...
Prospectively capture predictions using the authorised model or explicitly versioned successor.
...
- `docs/research/longitudinal_validation/evidence/12.06_frozen_replication_predictions.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Prospectively capture predictions using the authorised model or explicitly versioned successor.
...
6. Attach or link the required evidence: Frozen replication predictions.
...
- [ ] Frozen replication predictions.
