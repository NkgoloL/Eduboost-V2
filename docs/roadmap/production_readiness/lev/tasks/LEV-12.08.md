# LEV-12.08 — Implementation Task Card
...
Repeat the impact analysis or a confirmatory effectiveness design where feasible.
...
- `docs/research/longitudinal_validation/evidence/12.08_replication_impact_report.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.08.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Repeat the impact analysis or a confirmatory effectiveness design where feasible.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Replication impact report.
