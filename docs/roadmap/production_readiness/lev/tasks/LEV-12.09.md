# LEV-12.09 — Implementation Task Card
...
Compare effect direction, magnitude, uncertainty, calibration and subgroup patterns with the original.
...
- `docs/research/longitudinal_validation/evidence/12.09_cross_study_synthesis.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Compare effect direction, magnitude, uncertainty, calibration and subgroup patterns with the original.
...
6. Attach or link the required evidence: Cross-study synthesis.
