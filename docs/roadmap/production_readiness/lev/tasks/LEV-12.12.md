# LEV-12.12 — Implementation Task Card
...
Define which claims generalise, which require narrower scope and which must be withdrawn.
...
- `docs/research/longitudinal_validation/evidence/12.12_revised_authorised_use_register.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Define which claims generalise, which require narrower scope and which must be withdrawn.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Revised authorised-use register.
...
- [ ] Revised authorised-use register.
