# LEV-12.14 — Implementation Task Card
...
Set future replication cadence for major model families and high-impact uses.
...
- `docs/research/longitudinal_validation/evidence/12.14_ongoing_replication_policy.md`

## Implementation procedure

1. Read the LEV-WS12 workstream specification and confirm prerequisites for task 12.14.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Set future replication cadence for major model families and high-impact uses.
...
6. Attach or link the required evidence: Ongoing replication policy.
