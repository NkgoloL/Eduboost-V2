# LEV-13.02 — Implementation Task Card
...
Create authorised reference distributions and validation baselines for each production model.
...
- `docs/research/longitudinal_validation/evidence/13.02_baseline_registry.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.02.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create authorised reference distributions and validation baselines for each production model.
...
6. Attach or link the required evidence: Baseline registry.
