# LEV-13.04 — Implementation Task Card
...
Implement dashboards for calibration, error, retention, transfer, state reasonableness and context mix.
...
- `docs/research/longitudinal_validation/evidence/13.04_monitoring_dashboards.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.04.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Implement dashboards for calibration, error, retention, transfer, state reasonableness and context mix.
...
6. Attach or link the required evidence: Monitoring dashboards.
