# LEV-13.05 — Implementation Task Card
...
Implement item and anchor drift monitoring and automatic quarantine of suspect items.
...
- `docs/research/longitudinal_validation/evidence/13.05_item_drift_controls.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.05.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Implement item and anchor drift monitoring and automatic quarantine of suspect items.
...
6. Attach or link the required evidence: Item-drift controls.
