# LEV-13.06 — Implementation Task Card
...
Implement graph-change impact analysis covering renamed, merged, split, added and removed concepts.
...
- `docs/research/longitudinal_validation/evidence/13.06_graph_compatibility_checker.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.06.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Implement graph-change impact analysis covering renamed, merged, split, added and removed concepts.
...
6. Attach or link the required evidence: Graph compatibility checker.
