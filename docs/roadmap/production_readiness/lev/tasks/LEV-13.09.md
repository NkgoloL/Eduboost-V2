# LEV-13.09 — Implementation Task Card
...
Test alerts, authority reduction, feature flags, rollback and last-validated-model recovery.
...
- `docs/research/longitudinal_validation/evidence/13.09_operational_game_day_evidence.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Test alerts, authority reduction, feature flags, rollback and last-validated-model recovery.
...
6. Attach or link the required evidence: Operational game-day evidence.
