# LEV-13.11 — Implementation Task Card
...
Create recurring educational model review meetings combining SRE, psychometrics, curriculum and fairness evidence.
...
- `docs/research/longitudinal_validation/evidence/13.11_review_cadence_and_minutes.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.11.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create recurring educational model review meetings combining SRE, psychometrics, curriculum and fairness evidence.
...
6. Attach or link the required evidence: Review cadence and minutes.
