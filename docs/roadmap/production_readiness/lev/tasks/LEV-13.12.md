# LEV-13.12 — Implementation Task Card
...
Automate evidence capture for every model promotion, recalibration, threshold change and rollback.
...
- `docs/research/longitudinal_validation/evidence/13.12_release_evidence_bundle.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Automate evidence capture for every model promotion, recalibration, threshold change and rollback.
...
6. Attach or link the required evidence: Release evidence bundle.
