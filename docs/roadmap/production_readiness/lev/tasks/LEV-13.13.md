# LEV-13.13 — Implementation Task Card
...
Require revalidation before extending the model to a new grade, subject, language or high-impact use.
...
- `docs/research/longitudinal_validation/evidence/13.13_enforced_expansion_gate.md`

## Implementation procedure

1. Read the LEV-WS13 workstream specification and confirm prerequisites for task 13.13.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Require revalidation before extending the model to a new grade, subject, language or high-impact use.
...
6. Attach or link the required evidence: Enforced expansion gate.
