# LEV-14.03 — Implementation Task Card
...
Create a standard evidence dossier structure aligned to claims C1-C10 and the 15 definition-of-done conditions.
...
- `docs/research/longitudinal_validation/evidence/14.03_dossier_template.md`

## Implementation procedure

1. Read the LEV-WS14 workstream specification and confirm prerequisites for task 14.03.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Create a standard evidence dossier structure aligned to claims C1-C10 and the 15 definition-of-done conditions.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Dossier template.
