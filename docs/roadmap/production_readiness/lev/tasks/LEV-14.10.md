# LEV-14.10 — Implementation Task Card
...
Obtain one of four decisions: approved, approved with restrictions, further evidence required or rejected.
...
- `docs/research/longitudinal_validation/evidence/14.10_signed_decision_record.md`

## Implementation procedure

1. Read the LEV-WS14 workstream specification and confirm prerequisites for task 14.10.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Obtain one of four decisions: approved, approved with restrictions, further evidence required or rejected.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Signed decision record.
