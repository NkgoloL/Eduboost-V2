# LEV-14.11 — Implementation Task Card
...
Translate restrictions into enforceable feature flags, product wording, population limits and expiry dates.
...
- `docs/research/longitudinal_validation/evidence/14.11_restriction_implementation_verification.md`

## Implementation procedure

1. Read the LEV-WS14 workstream specification and confirm prerequisites for task 14.11.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Translate restrictions into enforceable feature flags, product wording, population limits and expiry dates.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Restriction implementation verification.
