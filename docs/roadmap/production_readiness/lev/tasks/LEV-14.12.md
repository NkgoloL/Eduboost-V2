# LEV-14.12 — Implementation Task Card
...
Publish an internal validation summary and an appropriate external transparency statement.
...
- `docs/research/longitudinal_validation/evidence/14.12_approved_communications.md`

## Implementation procedure

1. Read the LEV-WS14 workstream specification and confirm prerequisites for task 14.12.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Publish an internal validation summary and an appropriate external transparency statement.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Approved communications.
