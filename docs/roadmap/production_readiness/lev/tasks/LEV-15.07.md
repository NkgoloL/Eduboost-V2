# LEV-15.07 — Implementation Task Card
...
Add teacher- and administrator-facing explanations when a projection has insufficient evidence, stale evidence or unsupported context.
...
- `docs/research/longitudinal_validation/evidence/15.07_product_usability_review.md`

## Implementation procedure

1. Read the LEV-WS15 workstream specification and confirm prerequisites for task 15.07.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Add teacher- and administrator-facing explanations when a projection has insufficient evidence, stale evidence or unsupported context.
...
6. Attach or link the required evidence: Product usability review.
