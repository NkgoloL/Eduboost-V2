# LEV-15.09 — Implementation Task Card
...
Review all generated reports and analytics for misleading certainty or unsupported aggregation.
...
- `docs/research/longitudinal_validation/evidence/15.09_report_language_audit.md`

## Implementation procedure

1. Read the LEV-WS15 workstream specification and confirm prerequisites for task 15.09.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Review all generated reports and analytics for misleading certainty or unsupported aggregation.
4. Circulate the draft to accountable and consulted roles.
5. Resolve comments and obtain the required versioned approval.
6. Attach or link the required evidence: Report language audit.
