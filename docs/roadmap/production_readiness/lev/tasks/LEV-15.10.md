# LEV-15.10 — Implementation Task Card
...
Review contractual, privacy and consent materials to ensure research and operational uses are accurately distinguished.
...
- `docs/research/longitudinal_validation/evidence/15.10_legal_privacy_consistency_review.md`

## Implementation procedure

1. Read the LEV-WS15 workstream specification and confirm prerequisites for task 15.10.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Review contractual, privacy and consent materials to ensure research and operational uses are accurately distinguished.
...
6. Attach or link the required evidence: Legal/privacy consistency review.
...
- [ ] Legal/privacy consistency review.
