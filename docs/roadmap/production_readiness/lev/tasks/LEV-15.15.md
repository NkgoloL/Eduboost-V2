# LEV-15.15 — Implementation Task Card
...
Review limitations at least quarterly and after every material model, graph, item-bank or policy change.
...
- `docs/research/longitudinal_validation/evidence/15.15_review_records_and_no_expired_limitation_entries.md`

## Implementation procedure

1. Read the LEV-WS15 workstream specification and confirm prerequisites for task 15.15.
2. Open or update the task evidence record before changing code, data, instruments or governance documents.
3. Implement the required work exactly as scoped: Review limitations at least quarterly and after every material model, graph, item-bank or policy change.
...
6. Attach or link the required evidence: Review records and no expired limitation entries.
...
- [ ] Review records and no expired limitation entries.
