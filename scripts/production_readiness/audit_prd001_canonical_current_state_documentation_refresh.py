...
REQUIRED_PHRASES = ["RR roadmap/TODO register: closed", "KG roadmap: closed through KG-8", "Controlled runtime KG authority switch: executed", "Production-readiness stream: open", "Current authorised item: PRD-11.0R.RUNTIME-RESTORE.EXECUTION-8", "Production release remains blocked pending the PRD-11 release gate.", "production_release_authorised: false", "deployment_authorised: false", "public_beta_authorised: false", "billing_launch_authorised: false", "live_payment_processing_authorised: false", "new_kg_slice_authorised: false"]
