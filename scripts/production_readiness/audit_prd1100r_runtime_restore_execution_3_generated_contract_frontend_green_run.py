...
def audit(root: Path = ROOT) -> dict[str, Any]:
    ...
    valid = all([
        authority_valid,
        evidence_recorded,
        register.get("next_authorised_item") in {NEXT, NEXT_AFTER_EXECUTION_4, "PRD-11.0R.RUNTIME-RESTORE.EXECUTION-7"},
        prod_register.get("next_authorised_item") in {NEXT, NEXT_AFTER_EXECUTION_4, "PRD-11.0R.RUNTIME-RESTORE.EXECUTION-7"},
    ])
    return {
        "valid": valid,
