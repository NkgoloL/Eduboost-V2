...
def audit(root: Path = ROOT) -> dict[str, Any]:
    ...
    authority_valid = all([
        ...
        register.get("next_authorised_item") in {"PRD-2.7-2.9", "PRD-3"},
        prod_register.get("next_authorised_item") in {"PRD-2.7-2.9", "PRD-3"},
    ])
    ...
    valid = all([
        ...
        register.get("next_authorised_item") == "PRD-3",
        prod_register.get("next_authorised_item") == "PRD-3",
    ])
    return {
        "valid": valid,
