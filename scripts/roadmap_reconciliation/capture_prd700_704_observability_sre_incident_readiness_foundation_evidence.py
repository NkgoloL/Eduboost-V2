"""Capture PRD-7.0-7.4 observability, SRE, and incident readiness foundation evidence."""
...
SUMMARY = ROOT / "docs/roadmap/production_readiness/prd7_observability_sre_incident_readiness_foundation.json"
EVIDENCE_DIR = ROOT / "docs/release-evidence/production-readiness/prd-700-704-observability-sre-incident-readiness-foundation"
...
def main() -> int:
    ...
    parser.add_argument("--claim-prd700-704-observability-sre-incident-readiness-foundation", action="store_true")
    ...
    if not args.claim_prd700_704_observability_sre_incident_readiness_foundation:
        raise SystemExit("missing --claim-prd700-704-observability-sre-incident-readiness-foundation")
    ...
    readiness = build_default_observability_sre_readiness_report().to_payload()

    record = _load(RECORD)
    record.update({
        "observability_sre_foundation_recorded": True,
        "observability_sre_evidence_recorded": True,
        "observability_sre_readiness_snapshot": readiness,
        "captured_at": now,
        "prd_owner": args.prd_owner,
        "target_branch": args.target_branch,
        "next_authorised_item": "PRD-7.5-7.9",
    ...
    register.update({
        "status": "prd7_observability_sre_foundation_recorded",
        "last_recorded_item": "PRD-7.0-7.4",
    ...
    prod["current_truth"].update({
        "prd7_started": True,
        "prd7_observability_sre_foundation_recorded": True,
        "prd7_next_authorised_item": "PRD-7.5-7.9",
    })
    ...
    summary = {
        ...
        "observability_sre_readiness": readiness,
    ...
    _write(EVIDENCE_DIR / "observability_sre_readiness.json", readiness)
