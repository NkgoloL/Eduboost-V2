"""Capture PRD-8.5-8.9 performance/scale/cost final assurance evidence and handoff."""
...
from app.modules.performance_scale_cost.assurance import build_default_performance_scale_cost_final_assurance_report
from scripts.production_readiness.audit_prd805_809_performance_scale_cost_final_handoff import ROOT, audit
...
SUMMARY = ROOT / "docs/roadmap/production_readiness/prd8_performance_scale_cost_final_handoff.json"
EVIDENCE_DIR = ROOT / "docs/release-evidence/production-readiness/prd-805-809-performance-scale-cost-final-handoff"
...
def main() -> int:
    ...
    parser.add_argument("--claim-prd805-809-performance-scale-cost-final-handoff", action="store_true")
    ...
    if not args.claim_prd805_809_performance_scale_cost_final_handoff:
        raise SystemExit("missing --claim-prd805-809-performance-scale-cost-final-handoff")
    ...
    assurance = build_default_performance_scale_cost_final_assurance_report().to_payload()

    record = _load(RECORD)
    record.update({
        "performance_final_assurance_evidence_recorded": True,
        "performance_final_assurance_snapshot": assurance,
        "scale_cost_reconciliation_recorded": True,
        "performance_signoff_recorded": True,
        "prd8_final_reconciliation_recorded": True,
        "prd8_sequence_complete": True,
        "prd9_handoff_authorised": True,
        "captured_at": now,
        "prd_owner": args.prd_owner,
        "target_branch": args.target_branch,
        "next_authorised_item": "PRD-9",
    ...
    register.update({
        "status": "prd8_performance_scale_cost_closed",
        "last_recorded_item": "PRD-8.5-8.9",
    ...
    prod["current_truth"].update({
        "prd8_closed": True,
        "prd8_performance_scale_cost_final_assurance_recorded": True,
        "prd8_scale_cost_reconciliation_recorded": True,
        "prd8_final_reconciliation_recorded": True,
        "prd8_handoff_authorised": True,
        "prd8_next_authorised_item": "PRD-9",
    })
    ...
    prod.update({
        "status": "prd8_closed_prd9_handoff_authorised",
        "last_recorded_item": "PRD-8.5-8.9",
        "last_recorded_at": now,
        "next_authorised_item": "PRD-9",
        "prd8_closed": True,
    ...
    summary = {
        ...
        "performance_final_assurance": assurance,
    ...
    _write(EVIDENCE_DIR / "performance_scale_cost_final_assurance.json", assurance)
