...
#!/usr/bin/env python3
"""Verify PRD-1.0 CI/release-gate stream authority and register."""
...
from scripts.production_readiness.audit_prd100_ci_release_gate_stream_authority import audit
