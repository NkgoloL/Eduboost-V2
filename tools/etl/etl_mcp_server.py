...
===================================================================
Unified 32-tool FastMCP server powered by EduboostETLv3 across all phases.
...
from tools.etl.mcp_compat import FastMCP, ToolAnnotations
...
@mcp.tool(name="etl_ingest_document", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_document", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_list_documents", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_run_pipeline", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_run_stage", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_approve_document", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_reject_document", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_reprocess_document", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_review_queue", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_pipeline_stats", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_content_gaps", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_quality_report", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_document_chunks", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_update_metadata", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_create_document_version", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_search_fulltext", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_generate_training_data", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_list_training_datasets", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_export_dataset", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_submit_feedback", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_monitoring_report", annotations=ToolAnnotations(
...
@mcp.tool(name="etl_get_completeness_report", annotations=ToolAnnotations(
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Eduboost ETL MCP Server (Canonical)")
